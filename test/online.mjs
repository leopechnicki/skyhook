 ...
 * ======================================================================== */
{
  ...
  /* ---- setting the new password ---- */
  {
    ...
    let short = '';
    await s.Online.setNewPassword('short')
    ...
    let noSession = '';
    await s.Online.setNewPassword('a-brand-new-one')
  ...
  {
    const s = makeSandbox({
      hash: '#access_token=jwt-recovery-1&refresh_token=refresh-r&expires_in=3600&token_type=bearer&type=recovery'
    });
    s.Online.configure(CONFIG);
  ...
  {
    const s = makeSandbox({
      hash: '#access_token=jwt-access-1&refresh_token=refresh-1&expires_in=3600&token_type=bearer'
    });
    s.Online.configure(CONFIG);
